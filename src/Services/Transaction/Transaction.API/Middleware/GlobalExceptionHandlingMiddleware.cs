...
using AppValidationException = Transaction.Domain.Exceptions.ValidationException;
using AppInvalidOperationException = Transaction.Domain.Exceptions.InvalidOperationException;
